...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("coastalcph/lex_glue", "unfair_tos", split="train", cache_dir=model_args.cache_dir)

    if training_args.do_eval:
        eval_dataset = load_dataset("coastalcph/lex_glue", "unfair_tos", split="validation", cache_dir=model_args.cache_dir)

    if training_args.do_predict:
        predict_dataset = load_dataset("coastalcph/lex_glue", "unfair_tos", split="test", cache_dir=model_args.cache_dir)
