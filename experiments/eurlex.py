...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("hf://coastalcph/lex_glue", "eurlex", split="train", cache_dir=model_args.cache_dir)

    if training_args.do_eval:
        eval_dataset = load_dataset("hf://coastalcph/lex_glue", "eurlex", split="validation", cache_dir=model_args.cache_dir)

    if training_args.do_predict:
        predict_dataset = load_dataset("hf://coastalcph/lex_glue", "eurlex", split="test", cache_dir=model_args.cache_dir)
