...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("coastalcph/lex_glue", name=data_args.task, split="train", data_dir='data', cache_dir=model_args.cache_dir)

    if training_args.do_eval:
        eval_dataset = load_dataset("coastalcph/lex_glue", name=data_args.task, split="validation", data_dir='data', cache_dir=model_args.cache_dir)

    if training_args.do_predict:
        predict_dataset = load_dataset("coastalcph/lex_glue", name=data_args.task, split="test", data_dir='data', cache_dir=model_args.cache_dir)
